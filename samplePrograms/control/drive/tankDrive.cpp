...
/*
LeftMotor.move(ANALOG_RIGHT_Y); //replace LeftMotor with the name of your left drive motor
RightMotor.move(ANALOG_LEFT_Y); //replace RightMotor with the name of your right drive motor
*/
