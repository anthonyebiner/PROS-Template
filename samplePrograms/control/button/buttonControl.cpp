...
/*
if(Master.get_digital(DIGITAL_L1)){ //replace Master with the name of the controller
  motor.move(127); //replace motor with the name of the motor
}else if(Master.get_digital(DIGITAL_L2)){ //replace Master with the name of the controller
  motor.move(-127); //replace motor with the name of the motor
}else{
  motor.move(0); //replace motor with the name of the motor
}
*/
